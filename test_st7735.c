...
int main(int argc, char *argv[]) {
...
#if defined(ST7735_IMAGE_SUPPORT_BMP) && defined(ST7735_IMAGE_SUPPORT_BASE64)
    /* Test 16: Image/icon rendering */
    printf("[16] Image rendering (BMP icons)\n");
    st7735_fill(disp, COLOR_BLACK);
    /* 16x16 green checkmark */
    static const char icon_check_b64[] =
        "Qk02AwAAAAAAADYAAAAoAAAAEAAAABAAAAABABgAAAAAAAADAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAMgAAMgAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AMgAAMgAAMgAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM"
        "gAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMg"
        "AAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAMgAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMgAAMgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
    /* 16x16 red X */
    static const char icon_x_b64[] =
        "Qk02AwAAAAAAADYAAAAoAAAAEAAAABAAAAABABgAAAAAAAADAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM"
        "jLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAMjL"
        "cMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcMj"
        "LcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAA"
        "AAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAMjLcMjLcMjLc"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
    /* 16x16 yellow star */
    static const char icon_star_b64[] =
        "Qk02AwAAAAAAADYAAAAoAAAAEAAAABAAAAABABgAAAAAAAADAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAMj/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AAAAAAAAAMj/AMj/"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AAAAAAAAAAAAAMj/AMj/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AAAAAAAAAAAAAAAAAMj/AMj/AMj/"
        "AAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AAAAAAAAAAAAAAAAAMj/AMj/"
        "AMj/AAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/"
        "AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AAAAAAAAAAAAAMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AAAAAMj/AMj/AMj/AMj/AMj/AMj/AMj/"
        "AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AMj/AAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AMj/"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AMj/AMj/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMj/AMj/AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
    /* 16x16 red heart */
    static const char icon_heart_b64[] =
        "Qk02AwAAAAAAADYAAAAoAAAAEAAAABAAAAABABgAAAAAAAADAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMj"
        "LcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjL"
        "cAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAA"
        "MjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAMjLcMjLcMjLcM"
        "jLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMj"
        "LcMjLcMjLcMjLcAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjL"
        "cMjLcAAAAMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcMjLcAAAAAAAAMjLcMjLcMjLcMjLc"
        "MjLcAAAAAAAAMjLcMjLcMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAMjLcMjLcMjLcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";

    /* Draw icons in a grid */
    st7735_text(disp, 5, 5, COLOR_WHITE, COLOR_BLACK, 1, "Icons:");
    st7735_image(disp, 10, 20, icon_check_b64, sizeof(icon_check_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 35, 20, icon_x_b64, sizeof(icon_x_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 60, 20, icon_star_b64, sizeof(icon_star_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 85, 20, icon_heart_b64, sizeof(icon_heart_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 10, 45, icon_heart_b64, sizeof(icon_heart_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 35, 45, icon_star_b64, sizeof(icon_star_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 60, 45, icon_x_b64, sizeof(icon_x_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    st7735_image(disp, 85, 45, icon_check_b64, sizeof(icon_check_b64), ST7735_IMAGE_FORMAT_BMP, ST7735_IMAGE_ENCODING_BASE64);
    /* Labels */
    ...
    printf("[18] Image file loading\n");
    st7735_fill(disp, COLOR_BLACK);
#ifdef ST7735_IMAGE_SUPPORT_BMP
    printf("    Loading BMP...\n");
    if (st7735_image_file(disp, 5, 5, "test-image.bmp") == 0)
        printf("    BMP loaded OK\n");
    else {
        printf("    BMP load FAILED\n");
        st7735_text(disp, 5, 5, COLOR_RED, COLOR_BLACK, 1, "BMP FAILED");
    }
    if (use_buffer)
        st7735_flush(disp);
    sleep(3);
    ...
    printf("    Loading PNG...\n");
    if (st7735_image_file(disp, 5, 5, "test-image.png") == 0)
        printf("    PNG loaded OK\n");
    else {
        printf("    PNG load FAILED\n");
        st7735_text(disp, 5, 5, COLOR_RED, COLOR_BLACK, 1, "PNG FAILED");
    }
    if (use_buffer)
        st7735_flush(disp);
    sleep(3);
    ...
    st7735_fill(disp, COLOR_BLACK);
    printf("    Loading JPG...\n");
    if (st7735_image_file(disp, 5, 5, "test-image.jpg") == 0)
        printf("    JPG loaded OK\n");
    else {
        printf("    JPG load FAILED\n");
        st7735_text(disp, 5, 5, COLOR_RED, COLOR_BLACK, 1, "JPG FAILED");
    }
    if (use_buffer)
        st7735_flush(disp);
    sleep(3);
#endif
#if defined(ST7735_IMAGE_SUPPORT_BMP) && defined(ST7735_IMAGE_SUPPORT_PNG) && defined(ST7735_IMAGE_SUPPORT_JPG)
    printf("    Side by side...\n");
    st7735_fill(disp, COLOR_BLACK);
    st7735_text(disp, 5, 2, COLOR_WHITE, COLOR_BLACK, 1, "BMP:");
    st7735_text(disp, 55, 2, COLOR_WHITE, COLOR_BLACK, 1, "PNG:");
    st7735_text(disp, 105, 2, COLOR_WHITE, COLOR_BLACK, 1, "JPG:");
    st7735_image_file(disp, 5, 15, "test-image.bmp");
    st7735_image_file(disp, 55, 15, "test-image.png");
    st7735_image_file(disp, 105, 15, "test-image.jpg");
    if (use_buffer)
        st7735_flush(disp);
    sleep(3);
#endif
